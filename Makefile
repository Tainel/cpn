...
I3C := $(GPH)graph.cpp
I3D := $(GPH)minimum_spanning_tree.cpp
I3E := $(GPH)shortest_path.cpp
I3F := $(GPH)strongly_connected_components.cpp
I3G := $(GPH)topological_sort.cpp
I3H := $(GPH)traversal.cpp
...
IMP := $(I1A) $(I1B) $(I1C) $(I2A) $(I2B) $(I3A) $(I3B) $(I3C) $(I3D) $(I3E)\
$(I3F) $(I3G) $(I3H) $(I4A) $(I4B) $(I4C) $(I4D) $(I4E) $(I4F) $(I4G) $(I5A)\
$(I5B) $(I5C) $(I6A) $(I6B) $(I6C) $(I6D)
